    ...
    <div style="max-width:600px;">
      ...
      @else if (user()) {
        <div class="card card-body" style="margin-bottom:20px;text-align:center;">
          <div style="width:72px;height:72px;border-radius:50%;background:var(--warning);color:#fff;display:flex;align-items:center;justify-content:center;font-size:2rem;font-weight:700;margin:0 auto 14px;">{{ user()!.name[0].toUpperCase() }}</div>
